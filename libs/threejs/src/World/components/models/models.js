...
async function loadModels() {
  ...
  const [tableData, chairData, doorData] = await Promise.all([
      loader.loadAsync('libs/threejs/assets/models/table/scene.gltf'),
      loader.loadAsync('libs/threejs/assets/models/chair/scene.gltf'),
      loader.loadAsync('libs/threejs/assets/models/door/scene.gltf')
  ]);
